...
export function getPostBySlug(slug) {
  console.log("getPostBySlug looking for:", slug); // Debug
  console.log("Available slugs:", Object.keys(blogPosts)); // Debug
  const post = blogPosts[slug] || null;
  console.log("Found post:", post ? post.frontmatter.title : "null"); // Debug
  return post;
}
...
// Helper to add new posts (for future use)
export function addPost(slug, postData) {
  blogPosts[slug] = postData;
}

// Export the blogPosts object for debugging
export { blogPosts };
