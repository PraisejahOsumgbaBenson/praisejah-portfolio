          ...
          <div className="about-section">
              ...
              <div className="passage">
                <div className="first-section">
                  <span className="text-block first">
                    ...
                    I don&apos;t just write code; I experiment, break things,
                    and rebuild them better. <br />
                    Whether it&apos;s contributing to open source, designing
                    software architecture, or exploring bleeding-edge
                    technologies, I thrive at the intersection of creativity and
                    problem-solving.
                    <br />
                  </span>
                  <span className="text-block second">
                    Outside of tech, I find joy in painting and caring for
                    animals
                    <br />
                    both of which teach me patience, curiosity, and the beauty
                    of progress. I believe that the best solutions come from a
                    blend of skill, experimentation, and heart. <br />
                  </span>
                </div>
              </div>
            </div>
            ...
            <div className="scrolling-text">
              <div className="scrolling-content">
                ...
                <p>
                  .☘︎ ݁˖ Exploring Tech | ⋆⭒˚.⋆ Painting | ୨ৎ Animal Lover |
                  🍓ྀི Coding for Impact!
                </p>
                <p>
        ...
        <div className="experience-section" ref={experienceSectionRef}>
          ...
          <div className="experience-grid">
            ...
            <div className="experience-card card-5">
              ...
              <p className="card-description">
                Taught Scratch programming to 50+ peers and co-designed
                women&apos;s rights app prototypes, blending tech education with
                social advocacy.
              </p>
              <div className="card-tags">
